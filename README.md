...
|10        | Make a code for collecting the data and sending it to the server | Establish a connection to the server and send the obtained data| Dec 6 | B |11        | Make a code for getting the data in the refined fromat and send it to the csv file, and start with data collecting | Start data collecting by making the code for csv file data input | Dec 7| B|
## Test Plan
