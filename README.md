...
## Problem definition
The health center is in urgent need to solve a fast-growing problem at ISAK. Due to unoptimal humidity and temperature of the student rooms, ISAK students have been visiting nurses a lot more frequently with the issues related to soar throat. The nurses believe that the reasoning behind students sore throats is because of the humidity levels on campus. The nurses want a remote server that they can access online to check the different humidity levels at different times throughout the day. They want a server in which they can communicate with to recieve information regarding the different humiditiy levels.
